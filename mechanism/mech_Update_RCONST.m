...
% End INLINED RCONST                                               
   ...
   RCONST(430) = (GStruct.xBr*GStruct.xCl*jrates('J_BrCl',TIME, ...
                  GStruct));
   ...
   RCONST(434) = (GStruct.xBr*RACM_TROE(TEMP,M_conc,4.2E-31,2.4, ...
                  2.7E-11,0));
   RCONST(435) = (GStruct.xBr*4.5E-12*exp(460/TEMP)) ;
   RCONST(436) = (GStruct.xBr*8.8E-12*exp(260/TEMP)) ;
   RCONST(437) = (GStruct.xBr*RACM_TROE(TEMP,M_conc,5.4E-31,3.1, ...
                  6.5E-12,2.9));
   ...
   RCONST(449) = (GStruct.xBr*RACM_TROE(TEMP,M_conc,3.7E-29,5.3, ...
                  1.5E-10,2));
   ...
   RCONST(465) = (GStruct.xCl*RACM_TROE(TEMP,M_conc,1.85E-29,3.3, ...
                  6.0E-10,0.0));
   ...
   RCONST(485) = (2.50E-12*1.0) ;
   RCONST(486) = (aerosol_reaction_rates(1,TIME,GStruct)) ;
   RCONST(487) = (aerosol_reaction_rates(2,TIME,GStruct)) ;
   RCONST(488) = (aerosol_reaction_rates(3,TIME,GStruct)) ;
   RCONST(489) = (aerosol_reaction_rates(4,TIME,GStruct)) ;
   RCONST(490) = (aerosol_reaction_rates(5,TIME,GStruct)) ;
   RCONST(491) = (aerosol_reaction_rates(6,TIME,GStruct)) ;
   RCONST(492) = (aerosol_reaction_rates(7,TIME,GStruct)) ;
   RCONST(493) = (GStruct.xBr*aerosol_reaction_rates(8,TIME,GStruct)) ;
   RCONST(494) = (GStruct.xCl*aerosol_reaction_rates(9,TIME,GStruct)) ;
   RCONST(495) = (GStruct.xCl*aerosol_reaction_rates(10,TIME, ...
                  GStruct)/ClAer_t0);
   RCONST(496) = (GStruct.xCl*aerosol_reaction_rates(11,TIME, ...
                  GStruct)/ClAer_t0);
   RCONST(497) = (GStruct.xCl*aerosol_reaction_rates(12,TIME,GStruct)) ;
   RCONST(498) = (GStruct.xCl*aerosol_reaction_rates(13,TIME, ...
                  GStruct)/ClAer_t0);
   RCONST(499) = (GStruct.xCl*aerosol_reaction_rates(14,TIME, ...
                  GStruct)/ClAer_t0);
   RCONST(500) = (GStruct.xCl*GStruct.xBr*aerosol_reaction_rates(15, ...
                  TIME,GStruct)/BrAer_t0);
   RCONST(501) = (GStruct.xCl*GStruct.xBr*aerosol_reaction_rates(16, ...
                  TIME,GStruct)/BrAer_t0);
   RCONST(502) = (GStruct.xBr*aerosol_reaction_rates(17,TIME, ...
                  GStruct)/BrAer_t0);
   RCONST(503) = (GStruct.xBr*GStruct.xCl*aerosol_reaction_rates(18, ...
                  TIME,GStruct)/ClAer_t0);
   RCONST(504) = (GStruct.xBr*aerosol_reaction_rates(19,TIME, ...
                  GStruct)/BrAer_t0);
   RCONST(505) = (GStruct.xBr*GStruct.xCl*aerosol_reaction_rates(20, ...
                  TIME,GStruct)/ClAer_t0);
   RCONST(506) = (GStruct.xBr*aerosol_reaction_rates(21,TIME,GStruct)) ;
   RCONST(507) = (GStruct.xBr*aerosol_reaction_rates(22,TIME, ...
                  GStruct)/BrAer_t0);
   RCONST(508) = (GStruct.xBr*GStruct.xCl*aerosol_reaction_rates(23, ...
                  TIME,GStruct)/(BrAer_t0*BrAer_t0));
   RCONST(509) = (GStruct.xCl*aerosol_reaction_rates(24,TIME,GStruct)) ;
   RCONST(510) = (GStruct.xCl*GStruct.xBr*aerosol_reaction_rates(25, ...
                  TIME,GStruct));
   RCONST(511) = (GStruct.xCl*aerosol_reaction_rates(26,TIME,GStruct)) ;
   RCONST = RCONST(:);
