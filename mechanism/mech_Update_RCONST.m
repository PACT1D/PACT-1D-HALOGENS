...
% End INLINED RCONST                                               
   ...
   RCONST(497) = (GStruct.xCl*aerosol_reaction_rates(10,TIME, ...
                  GStruct)/ClAer_t0);
   RCONST(498) = (GStruct.xCl*aerosol_reaction_rates(11,TIME, ...
                  GStruct)/ClAer_t0);
   RCONST(499) = (GStruct.xCl*aerosol_reaction_rates(12,TIME,GStruct)) ;
   RCONST(500) = (GStruct.xCl*aerosol_reaction_rates(13,TIME, ...
                  GStruct)/ClAer_t0);
   RCONST(501) = (GStruct.xCl*aerosol_reaction_rates(14,TIME, ...
                  GStruct)/ClAer_t0);
   RCONST(502) = (GStruct.xCl*GStruct.xBr*aerosol_reaction_rates(15, ...
                  TIME,GStruct)/BrAer_t0);
   RCONST(503) = (GStruct.xCl*GStruct.xBr*aerosol_reaction_rates(16, ...
                  TIME,GStruct)/BrAer_t0);
   RCONST(504) = (GStruct.xBr*aerosol_reaction_rates(17,TIME, ...
                  GStruct)/BrAer_t0);
   RCONST(505) = (GStruct.xBr*GStruct.xCl*aerosol_reaction_rates(18, ...
                  TIME,GStruct)/ClAer_t0);
   RCONST(506) = (GStruct.xBr*aerosol_reaction_rates(19,TIME, ...
                  GStruct)/BrAer_t0);
   RCONST(507) = (GStruct.xBr*GStruct.xCl*aerosol_reaction_rates(20, ...
                  TIME,GStruct)/ClAer_t0);
   RCONST(508) = (GStruct.xBr*aerosol_reaction_rates(21,TIME,GStruct)) ;
   RCONST(509) = (GStruct.xBr*aerosol_reaction_rates(22,TIME, ...
                  GStruct)/BrAer_t0);
   RCONST(510) = (GStruct.xBr*GStruct.xCl*aerosol_reaction_rates(23, ...
                  TIME,GStruct)/(BrAer_t0*BrAer_t0));
   RCONST(511) = (GStruct.xCl*aerosol_reaction_rates(24,TIME,GStruct)) ;
   RCONST(512) = (GStruct.xCl*GStruct.xBr*aerosol_reaction_rates(25, ...
                  TIME,GStruct));
