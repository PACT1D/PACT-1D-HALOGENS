...
%+SAhmed - FOR CHLORIDE AND BROMIDE CONCENTRATION ON AEROSOLS
%Get the initial concentrations of chloride and bromide on aerosols (in
%molec cm-3 (air))
global ClAer_t0; ClAer_t0 = spec_t0(ind_ClAer);
global BrAer_t0; BrAer_t0 = spec_t0(ind_BrAer);
...
%+SAhmed 
%Convert chloride and bromide back to molec cm-3(air)
for l=1:NLEV
    spec(ind_ClAer,l,1) = spec_t0(ind_ClAer,l);
    spec(ind_BrAer,l,1) = spec_t0(ind_BrAer,l);
end
